...
- 🧭 بوصلة قبلة فاخرة مع حساس مغناطيسي
- 🕋 **تقويم هجري هجين** — 30+ دولة، يقرأ التقويم الرسمي
  من AlAdhan API (وزارة الأوقاف المغربية، أم القرى السعودية،
  Diyanet التركية، Kemenag الإندونيسية، ...) ويسقط للحساب
  المحلي عند انقطاع الإنترنت. تفاصيل في
  [`docs/hybrid_hijri_calendar.md`](docs/hybrid_hijri_calendar.md).
- 💾 حفظ محلي تلقائي
