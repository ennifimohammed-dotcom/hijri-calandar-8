...
class AppProvider extends ChangeNotifier {
  ...
  String label(String key) {
    final map = <String, Map<String, String>>{
      ...
      'qibla_accuracy_high':       {'ar':'دقة عالية','fr':'Précision élevée','en':'High accuracy','es':'Alta precisión'},
      'qibla_accuracy_medium':     {'ar':'دقة متوسطة','fr':'Précision moyenne','en':'Medium accuracy','es':'Precisión media'},
      'qibla_accuracy_low':        {'ar':'دقة منخفضة','fr':'Faible précision','en':'Low accuracy','es':'Baja precisión'},
      'qibla_calibrate':           {'ar':'البوصلة تحتاج معايرة — حرّك الهاتف بشكل ٨','fr':'Calibrez la boussole — bougez le téléphone en 8','en':'Compass needs calibration — move phone in figure 8','es':'La brújula necesita calibración — mueva el teléfono en 8'},
